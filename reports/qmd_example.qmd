...
![Horse](../results/horse_pops_plot.png){#fig-pop}

Figure 1: Horse populations for all provinces in Canada from 1906 - 1972.

We can see from @fig-pop 1 that Ontario, Saskatchewan and Alberta 
...
![Horse](../results/horse_pops_plot_largest_sd.png){#fig-pop, width=70%}
